...
var domainname = "http://"+window.location.host+"/website-ocentag/";
				...
				success: function(data) {
					...
					jQuery.each(objGridData, function(index, key) {
						...
						var tempGridJsonData = '<div id="gridrow_'+ objGridData[index].entity_id +'" class="gridrow_'+ objGridData[index].entity_id+' gridrow ' + tempClassType +' '+tempDivclass +'" style=' + bg_color + color + '>' +                   
												...
												'<div class="gridcolumn0"><a style="cursor:pointer"  onClick="showFullPopDiv(' + objGridData[index].entity_id + ', ' + objGridData[index].imgStatus + ', ' + index + ')"><img src="/website_ocentag/static/src/images/' + imgProd + '"></div></a>' +
												...
												'<div class="gridcolumn15"><a href="javascript:void(0);" class="imgChk' + objGridData[index].entity_id + '" onClick="chkClickEvent(this,' + objGridData[index].entity_id + ')"><img class="imgChk" alt="check" src="/website_ocentag/static/src/images/uncheck_box.png" /></a></div>' +                    
												'</div>' +
...
//        var url = 'http://localhost:8069/website-test/submit_json';
        ...
        if(type != 'search')
		{
			...
			jQuery(".DivGridInnerData").html('<img style="padding-left:350px" src="/website_ocentag/static/src/images/ajax-loader.gif" alt="Please wait" />');
		}
        ...
        openerp.jsonRpc("/website-ocentag/submit_json", 'call', {
            'data': filterParams})
            .then(function (data) {
...
//
    ...
    function gridSortData(gridFilterattr)
    {
        ...
        jQuery(rmImgId).attr('src', '/website_ocentag/static/src/images/arrow_up_down.png');
        ...
        if (tempFlagFilterSort == 1) {
            ...
            jQuery(imgId).attr('src', '/website_ocentag/static/src/images/arrow_up.png');
            ...
            jQuery(imgId).removeAttr("style");
            jQuery(imgId).attr('src', '/website_ocentag/static/src/images/arrow_down.png');
            jQuery(imgId).attr('style', '');
            jQuery(imgId).css('height', '4px');
            jQuery(imgId).css('width', '7px');
        }
    ...
    function chkClickEvent(objBtn, entity_id)
    {
        ...
        {
            jQuery(objBtn).html('<img class="imgChk" alt="uncheck" src="/website_ocentag/static/src/images/check_box.png" />');
            loadCompareGridData(entity_id, 'add');
        }
        else if (jQuery(objBtn).find("img").attr('alt') == "uncheck")
        {
            jQuery(objBtn).html('<img class="imgChk" alt="check" src="/website_ocentag/static/src/images/uncheck_box.png" />');
    ...
    function chkClickAll(objBtn)
    {
        if (jQuery(objBtn).find("img").attr('alt') == "check")
        {
            jQuery(objBtn).find('img').attr('alt', 'uncheck').attr('src', '/website_ocentag/static/src/images/check_box.png');
            jQuery('.gridrow > .gridcolumn15').find('img').attr('src', '/website_ocentag/static/src/images/check_box.png').attr('alt', 'uncheck');
        ...
        {
            jQuery(objBtn).find('img').attr('alt', 'check').attr('src', '/website_ocentag/static/src/images/uncheck_box.png');
            jQuery('.gridrow > .gridcolumn15').find('img').attr('src', '/website_ocentag/static/src/images/uncheck_box.png').attr('alt', 'check');
    ...
    function setCompareGrid()
    {
        ...
        jQuery.each(jsonCompareData, function(index, key) {
            ...
            var tempGridJsonData = '<div class="gridrow entity' + jsonCompareData[index].entity_id + ' ' + tempClassType + '" class=' + tempDivclass + '>' +
                    ...
                    '<div class="gridcolumn0"><a style="cursor:pointer"  onClick="showFullPopDiv(' + jsonCompareData[index].entity_id + ', ' + jsonCompareData[index].imgStatus + ', ' + index + ')"><img  src="/website_ocentag/static/src/images/' + imgProd + '"></div></a>' +
                    ...
                    '<div class="gridcolumn15"><a href="javascript:void(0);" onClick="removeCompareRow(' + jsonCompareData[index].entity_id + ',/main/)"><img src="/website_ocentag/static/src/images/removeCompare.gif" /></a></div>' +
                    '</div>' +
    ...
    function removeCompareRow(entity_id, objChk)
    {
        ...
        if (tempMain != "main") {
            jQuery(objChk).html('<img class="imgChk" alt="check" src="/website_ocentag/static/src/images/uncheck_box.png" />');
        } else {
            jQuery('.imgChk' + entity_id).html('<img class="imgChk" alt="check" src="/website_ocentag/static/src/images/uncheck_box.png" />');
        }
        var loopflag = false;
...
//					});
    ...
    function showFullPopDiv(entity_id, imgStatus)
    {
        ...
        openerp.jsonRpc("/website-ocentag/popup", 'call', {
